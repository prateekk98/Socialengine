 ...
 * @license    http://www.socialengine.com/license/
 */
class User_Widget_LoginPageController extends Engine_Content_Widget_Abstract
{
  public function indexAction()
  {
    ...
    $this->view->image = Engine_Api::_()->getApi('settings', 'core')->getSetting('core.general.landingimage', '');
