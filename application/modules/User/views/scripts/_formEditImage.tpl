...
<?php if( $this->subject()->photo_id !== null ): ?>
  ...
  <script type="text/javascript">
    ...
    var lassoStart = function()
    {
      ...
      $('thumbnail-controller').innerHTML = '<a href="javascript:void(0);" onclick="lassoCancel();"><?php echo $this->translate('cancel');?></a>';
    ...
    var lassoCancel = function() {
      ...
      $('thumbnail-controller').innerHTML = '<a href="javascript:void(0);" onclick="lassoStart();"><?php echo $this->translate('Edit Profile Photo');?></a>';
      $('coordinates').value = "";
      lassoCrop.destroy();
    }
