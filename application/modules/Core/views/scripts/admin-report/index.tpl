...
if( $settings->getSetting('user.support.links', 0) == 1 ) {
	echo 'More info: <a href="https://socialengine.atlassian.net/wiki/spaces/SU/pages/5341527/se-php-abuse-reports" target="_blank">See KB article</a>.';
} 
?>	
<br />
<br />
  ...
  <table class='admin_table'>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td style="white-space: normal;"><?php echo $this->escape($item->description) ?></td>
