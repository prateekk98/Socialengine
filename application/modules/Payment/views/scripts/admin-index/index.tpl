...
<p>
  ...
  if( $settings->getSetting('user.support.links', 0) == 1 ) {
          echo 'More info: <a href="https://socialengine.atlassian.net/wiki/spaces/SU/pages/5243346/SE+PHP+-+Transactions" target="_blank">See KB article</a>.';
  } 
  ?>
</p>
      ...
      <?php foreach( $this->paginator as $item):
        ...
        <tr>
          ...
          <td class='admin_table_options'>
            ...
            <?php if(in_array($gateway->gateway_id,array(4,5,6,7))){ ?>
            <?php 
              if($item->state == "okay"){
