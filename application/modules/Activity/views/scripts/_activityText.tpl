                    ...
                    <div>
                      ...
                      <div class='feed_item_link_desc'>
                        ...
                        <?php if (strip_tags($action->body) != $attachmentDescription): ?>
                          <?php if(in_array($action->type, array('forum_topic_create', 'forum_topic_reply', 'group_topic_create', 'event_topic_create', 'group_topic_reply', 'event_topic_reply'))) { ?>
                            <?php echo $this->viewMore(strip_tags($attachmentDescription), 255, 1027, 511, false); ?>
                          <?php } else { ?>
                            <?php echo $this->viewMore(strip_tags($attachmentDescription)); ?>
                          <?php } ?>
                        <?php endif; ?>
                      </div>
                    </div>
